        ...
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'phase' => 'P4',
                    'permission' => ['leave.file', 'leave.approve', 'leave.manage'],
                    'req_ids' => ['LEV-001', 'LEV-002'],
                    'flowchart' => 'leave → Employee files request · modules → Leave + OT',
                    'summary' => 'Leave filing with Approver → HR workflow (or HR-only for requires_hr types); VL credits/accrual (P4a).',
                ],
                [
                    'key' => 'overtime',
                    'label' => 'Overtime',
                    ...
                    'icon' => 'ph-timer',
                    'phase' => 'P4',
                    'permission' => ['ot.file', 'ot.approve', 'ot.manage'],
                    'req_ids' => ['OT-001'],
                    'flowchart' => 'leave → OT approval flow · modules → Leave + OT',
                    'summary' => 'OT and OT Meal filings with multi-level Approver → HR workflow (Annex A matrices later).',
                ],
                [
                    'key' => 'workflow',
                    ...
                    'icon' => 'ph-git-branch',
                    'phase' => 'P4',
                    'permission' => ['ot.approve', 'ot.manage', 'leave.approve', 'leave.manage'],
                    'req_ids' => ['WF-001'],
                    'flowchart' => 'leave → Approver 1 → Approver 2 → HR',
                    'summary' => 'Shared multi-level approval inbox for Leave and OT (Travel later; Annex A matrices later).',
                ],
            ],
        ],
        ...
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'phase' => 'P3–P4',
                    'permission' => ['leave.file', 'employees.view'],
                    'req_ids' => ['NOT-001'],
                    'flowchart' => 'leave → email notify · delivery P3–P4',
                    'summary' => 'In-app inbox + email alerts (welcome, document expiry; more as modules ship). Topbar bell + /modules/notifications.',
                ],
            ],
        ],
